...
class Reader(object):
    ...
    def __init__(self, lang_list, gpu=True, model_storage_directory=None,
        ...
        if recog_network in ['standard'] + [model for model in recognition_models['gen1']] + [model for model in recognition_models['gen2']]:
            ...
            # ===================== custom code ================================
            # Concatenate strings to form the file path
            # file_path = os.path.join(self.user_network_directory, recog_network + '.yaml')
            # print("Generated file path:", file_path)

            # # Open the YAML file and load the configuration
